...
The aim is to analyze direct and indirect effects on **Self-esteem** for the model `fit2`. To reference the first part of our project, we rename our latent variables:
...
The aim is to analyse direct and indirect effects on **Self-esteem** for the model `fit3`. To reference to the first part of our project, we rename our latent variables as we already have done for `fit1` and `fit2` : 
